 ...
 * Slug: wp-block-theme-boilerplate/header-absolute
 * Categories: header
...
?>
<!-- wp:group {"className":"companydomain-wbtb-header at-pos at-z-idx","style":{"spacing":{"blockGap":"0px"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group companydomain-wbtb-header at-pos at-z-idx"><!-- wp:group {"align":"full","className":"pw-t-head","style":{"spacing":{"padding":{"top":"10px","bottom":"10px"}}},"backgroundColor":"base","layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull pw-t-head has-base-background-color has-background" style="padding-top:10px;padding-bottom:10px"><!-- wp:group {"align":"wide","layout":{"type":"flex","flexWrap":"wrap","justifyContent":"center"}} -->
