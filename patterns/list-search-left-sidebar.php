<?php
/**
 * Title: Search Page with Left Sidebar
 * Slug: wp-block-theme-boilerplate/list-search-left-sidebar
 * Template Types: search
 * Description: Layout template for displaying a list of posts with a left sidebar.
 *
