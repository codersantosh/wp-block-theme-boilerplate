...
?>
<!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/banner-img.png","id":31,"dimRatio":0,"focalPoint":{"x":0,"y":1},"contentPosition":"top center","isDark":false,"metadata":{"name":"Hero Banner"},"align":"full","className":"companydomain-wbtb-hero-banner at-pos at-z-idx","layout":{"type":"constrained"}} -->
<div class="wp-block-cover alignfull is-light has-custom-content-position is-position-top-center companydomain-wbtb-hero-banner at-pos at-z-idx"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-31" alt="" src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/banner-img.png" style="object-position:0% 100%" data-object-fit="cover" data-object-position="0% 100%"/><div class="wp-block-cover__inner-container">
