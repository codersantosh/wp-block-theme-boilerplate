<?php
/**
 * Title: Search Page with Right Sidebar
 * Slug: wp-block-theme-boilerplate/list-search-right-sidebar
 * Template Types: search
 * Description: Layout template for displaying a list of posts with a right sidebar.
 *
